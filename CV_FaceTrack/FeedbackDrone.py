...
#Import the ai models from mac to raspberry pi and inference it either on oak d lite or using rpi camera and neural compute stick designed for raspberry pi.
